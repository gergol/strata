...
**Status: Phase 1 underway — [live at gergol.github.io/strata](https://gergol.github.io/strata/).** Forty browser-verified query layers span OpenStreetMap and Wikidata packs, WFS, sampled Open-Meteo weather/air quality, SoilGrids, Austria's electricity mix, compact Ookla/Eurostat indexes, and live GBFS bike-share availability in Vienna, Linz, and Bratislava. The 41-layer catalogue also includes SoilGrids and ESA WorldCover raster overlays. The MapLibre PWA selects and centers the current location on startup, and has searchable lazy result panels, shared provider-level rate limiting, browser-aware scheduled health, reproducible materialization recipes, BYOK settings, and deterministic UI/offline regression tests.
