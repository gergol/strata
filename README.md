...
**Status: Phase 1 complete — [live at gergol.github.io/strata](https://gergol.github.io/strata/).** Forty browser-verified query layers span OpenStreetMap and Wikidata packs, WFS, sampled Open-Meteo weather/air quality, SoilGrids, Austria's electricity mix, compact Ookla/Eurostat indexes, and live GBFS bike-share availability. The 43-layer catalogue also includes WorldCover, date-selectable NASA GIBS true colour, and Vienna's official 1971 aerial imagery. The MapLibre PWA selects and centers the current location on startup, and has searchable lazy result panels, descriptor-styled map results, shared provider-level rate limiting, browser-aware scheduled health, reproducible materialization recipes, BYOK settings, and deterministic UI/offline regression tests.
